...
class SaleService extends SoapClient {
  ...
  public function SaleService($wsdl = "http://clients.mindbodyonline.com/api/0_5/SaleService.asmx?WSDL", $options = array()) {
...
class_alias("SaleService", "Sale_x0020_Service");
?>