...
class ClassService extends SoapClient {
  ...
  public function ClassService($wsdl = "http://clients.mindbodyonline.com/api/0_5/ClassService.asmx?WSDL", $options = array()) {
...
class_alias("ClassService", "Class_x0020_Service");
?>